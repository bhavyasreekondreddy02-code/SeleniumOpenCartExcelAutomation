        ...
        try {
            ...
            if (exp.equalsIgnoreCase("valid")) {
                ...
                if (accountPage) {
                    ...
                    // ✅ Unified assertion: accept both invalid login and exceeded attempts
                    Assert.assertTrue(
                        warningMsg.contains("Warning: No match for E-Mail Address and/or Password.") ||
                        warningMsg.contains("Warning: Your account has exceeded allowed number of login attempts"),
                        "Unexpected warning message: " + warningMsg
                    );
                }
            }
